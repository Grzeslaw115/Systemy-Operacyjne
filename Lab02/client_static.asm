...
0000000000001229 <main>:
    ...
    129b:	48 8d 05 54 00 00 00 	lea    0x54(%rip),%rax        # 12f6 <test_collatz_convergence>
...
00000000000012f6 <test_collatz_convergence>:
    12f6:	f3 0f 1e fa          	endbr64 
    12fa:	55                   	push   %rbp
    12fb:	48 89 e5             	mov    %rsp,%rbp
    12fe:	48 83 ec 18          	sub    $0x18,%rsp
    1302:	89 7d ec             	mov    %edi,-0x14(%rbp)
    1305:	89 75 e8             	mov    %esi,-0x18(%rbp)
    1308:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    130f:	eb 11                	jmp    1322 <test_collatz_convergence+0x2c>
    1311:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1314:	89 c7                	mov    %eax,%edi
    1316:	e8 aa ff ff ff       	call   12c5 <collatz_conjecture>
    131b:	89 45 ec             	mov    %eax,-0x14(%rbp)
    131e:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    1322:	83 7d ec 01          	cmpl   $0x1,-0x14(%rbp)
    1326:	74 08                	je     1330 <test_collatz_convergence+0x3a>
    1328:	8b 45 fc             	mov    -0x4(%rbp),%eax
    132b:	3b 45 e8             	cmp    -0x18(%rbp),%eax
    132e:	7c e1                	jl     1311 <test_collatz_convergence+0x1b>
    1330:	83 7d ec 01          	cmpl   $0x1,-0x14(%rbp)
    1334:	74 07                	je     133d <test_collatz_convergence+0x47>
    1336:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    133b:	eb 03                	jmp    1340 <test_collatz_convergence+0x4a>
